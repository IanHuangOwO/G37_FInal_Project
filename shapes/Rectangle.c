...
Shape *New_Rectangle(double x1, double y1, double x2, double y2)
{
	...
	pObj->get_top = Rectangle_get_top;
	pObj->get_bottom = Rectangle_get_bottom;
	pObj->get_left = Rectangle_get_left;
	pObj->get_right = Rectangle_get_right;
...
double Rectangle_get_top(Shape *self) {
	return Rectangle_Self(self)->y1;
}

double Rectangle_get_bottom(Shape *self) {
	return Rectangle_Self(self)->y2;
}

double Rectangle_get_left(Shape *self) {
	return Rectangle_Self(self)->x1;
}

double Rectangle_get_right(Shape *self) {
	return Rectangle_Self(self)->x2;
}
